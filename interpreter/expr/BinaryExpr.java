...
public class BinaryExpr extends Expr {
    ...
    private Value<?> ifNullOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
        if (v1==null){
            return v2;
        }
        else{
    ...
    private Value<?> andOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
        if (v1 instanceof BoolValue && v2 instanceof BoolValue) {// Mudei de NumberValue para BoolValue
    ...
    private Value<?> orOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
    ...
    private Value<?> equalOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
    ...
    private Value<?> notEqualOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
        if (v1 instanceof NumberValue && v2 instanceof NumberValue) {
            NumberValue nv1 = (NumberValue) v1;
            NumberValue nv2 = (NumberValue) v2;
    ...
    private Value<?> addOp(Value<?> v1, Value<?> v2) {// PELUCIVIA
        if (v1 instanceof NumberValue && v2 instanceof NumberValue) {
            NumberValue nv1 = (NumberValue) v1;
            NumberValue nv2 = (NumberValue) v2;
